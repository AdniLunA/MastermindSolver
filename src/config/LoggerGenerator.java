...
public enum LoggerGenerator {
    ...
    public static final Logger tournamentSelection = LogManager.getLogger(TournamentSelection.class);
    public static final Logger numChromosome = LogManager.getLogger(NumChromosome.class);
