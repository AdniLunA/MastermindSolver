...
public class ConfigurationAnalysis {
    ...
    private static final IChromosome codeToSolve = new NumChromosome(new int[]{1, 2, 3, 4, 5});

    public static void main(String... args) {
        engine.settingsSetLocNocNot(5, 12, 15);
        ...
        solveWithParams(20, SelectionEnum.ROULETTE_WHEEL, CrossoverEnum.K_POINT, MutationEnum.SCRAMBLE, 0.003);
        solveWithParams(21, SelectionEnum.ROULETTE_WHEEL, CrossoverEnum.K_POINT, MutationEnum.SCRAMBLE, 0.001);*/
    }
